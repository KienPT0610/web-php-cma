...
if($id === null || !isset($sellers[$id])) {
  header('Location: /sellers');
  exit;
}
$data = $sellers[$id] ?? null;
if($data === null) {
  header('Location: /sellers');
  exit;
}
    ...
    <form class="form-register" novalidate>
      ...
      <div class="mb-3">
        ...
        <div class="avatar-preview mb-2">
          <img src="/assets/images/avatar.png" alt="Avatar Preview" id="avatarPreview" class="rounded-circle"
      ...
      <div class="mb-3">
        <div class="row">
          <div class="col-md-3 d-flex gap-3 mb-3">
            ...
            <input type="date" id="date" name="date" value="2004-10-06" required>
          </div>
